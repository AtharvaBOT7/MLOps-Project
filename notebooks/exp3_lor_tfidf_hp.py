...
dagshub.init(repo_owner="atharvachundurwar841", repo_name="MLOps-Project", mlflow=True)  # <-- fixed repo_name
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    ...
    with mlflow.start_run():
        ...
        # Log the best model (safely, as artifacts)
        ...
        # Replaces: mlflow.sklearn.log_model(best_model, "model")
        log_model_as_artifacts(best_model, artifact_path="model")
